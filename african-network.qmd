...
df_nodes <- read.csv("https://github.com/CrmnCA/nets4gis/raw/main/data/AfricaNetworkNodes.csv")

# Read the CSV file containing network nodes data from a URL
df_edges <- read.csv("https://github.com/CrmnCA/nets4gis/raw/main/data/AfricaNetworkEdges.csv")
```
